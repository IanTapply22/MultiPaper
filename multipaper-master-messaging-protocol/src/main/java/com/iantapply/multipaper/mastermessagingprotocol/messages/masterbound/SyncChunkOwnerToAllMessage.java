...
public class SyncChunkOwnerToAllMessage extends MasterBoundMessage {

    public final String world;
    public final int cx;
    public final int cz;

    public SyncChunkOwnerToAllMessage(String world, int cx, int cz) {
        this.world = world;
        this.cx = cx;
        this.cz = cz;
    }

    public SyncChunkOwnerToAllMessage(ExtendedByteBuf byteBuf) {
