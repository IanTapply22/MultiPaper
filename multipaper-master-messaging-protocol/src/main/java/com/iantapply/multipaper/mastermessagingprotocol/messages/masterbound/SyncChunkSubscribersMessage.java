...
public class SyncChunkSubscribersMessage extends MasterBoundMessage {

    public final String world;
    public final int cx;
    public final int cz;

    public SyncChunkSubscribersMessage(String world, int cx, int cz) {
        this.world = world;
        this.cx = cx;
        this.cz = cz;
    }

    public SyncChunkSubscribersMessage(ExtendedByteBuf byteBuf) {
